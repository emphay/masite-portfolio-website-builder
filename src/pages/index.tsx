  ...
  return (
    <>
      <Head>
        ...
        <meta name="msapplication-TileImage" content="https://raw.githubusercontent.com/emphay/masite-portfolio-website-builder/main/public/img/sitedesign.png" />

        {/* fb & WhatsApp */}

        {/* Site Name, Title, and Description to be displayed */}
        <meta property="og:site_name" content="Masite: A Portfolio Website Builder" />
        <meta property="og:title" content="Build Your Portfolio with Masite" />
        <meta property="og:description" content="Effortlessly create and customize your personal portfolio website using Masite. Show off your work and projects with ease." />
